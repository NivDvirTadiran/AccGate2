...
export default {
  title: 'Design System/Forms/ForgotPassForm',
...
const forgotPassForm = new FormGroup({
...
export const IdentifyFailed = Template.bind({});
IdentifyFailed.args = {
  // Shaping the stories through args composition.
  // Inherited data coming from the Default story.
  storyInputs: [
...
export const IdentifySuccess = Template.bind({});
IdentifySuccess.args = {
  // Shaping the stories through args composition.
  // Inherited data coming from the Default story.
  storyInputs: [
    ...Default.args['storyInputs'].slice(0, 2),
