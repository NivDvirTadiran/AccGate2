...
const Template: Story<ButtonContinueComponent> = (args: ButtonContinueComponent) => ({
  props: args,
});

const Template2: Story<ButtonContinueComponent> = (args: ButtonContinueComponent) => ({
  props: args,
